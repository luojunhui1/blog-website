...
import helloPic from "@/public/img/face.jpg";
    ...
    <div className="pt-4 font-title">
      <div className="primary relative flex flex-col-reverse justify-between p-4 font-title sm:flex-row sm:p-8">
        <div className="z-20">
          ...
          <p className="text-lg">
            <span className="opacity-80">Software Engineer at </span>
            <Link href="https://www.jdcloud.com/">JD Cloud</Link>
          </p>
          <div className="mt-5 flex">
            <a
              ...
              href="https://github.com/luojunhui1">
              <svg
