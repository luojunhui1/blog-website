...
const Callout = ({ pic, icon, title, children }: CalloutProps) => {
  ...
  return (
    <div className="callout secondbg relative z-20 mx-auto my-2 break-inside-avoid-page rounded-lg px-4 py-3">
      {icon && (
      ...
      <div className="sm:px-4">
        {title && (
          <div className="not-prose">
            <p className="font-sans text-base font-semibold md:mb-2 md:mt-2 md:text-lg">
              {title}
            </p>
          </div>
        )}
